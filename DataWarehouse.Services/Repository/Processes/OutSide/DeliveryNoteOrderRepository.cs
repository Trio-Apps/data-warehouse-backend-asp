...
namespace DataWarehouse.Services.Repository.Processes.OutSide
{
    ...
    public class DeliveryNoteOrderRepository : BaseRepository<DeliveryNoteOrder>, IDeliveryNoteOrderRepository
    {
        ...
        /// <summary>
        /// إنشاء Delivery Note بناءً على Sales Order (Parent) + نسخ items
        /// </summary>
...
//                .Include(so => so.DeliveryNoteOrder)  // للتحقق هل اتعمل DN قبل كده
                .Include(so => so.SalesOrderItems)    // لنسخ items
        ...
        /// <summary>
        /// إنشاء Delivery Note بدون SalesOrder reference
        /// </summary>
        ...
        /// <summary>
        /// إنشاء Delivery Note بناءً على SalesOrderId (Reference فقط) بدون نسخ items
        /// </summary>
            ...
            string userId, int deliveryNoteOrderId, UpdateDeliveryNoteOrderDTO dto)
        {
            ...
            // ✅ منع تعديل Customer لو الـ DeliveryNote مبني على SalesOrder
